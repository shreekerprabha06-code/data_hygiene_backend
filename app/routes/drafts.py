...
async def get_draft_executions(user: dict = Depends(get_current_user)):
    """
...
async def get_draft_record_fields(type: str = Query(..., description="Record type: cpumodel, instancetype, or any other masterlist type"), user: dict = Depends(get_current_user)):
    """
